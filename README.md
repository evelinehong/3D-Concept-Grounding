...
python train_vnn_occupancy_net.py 
    ...
    --test True
```
(TODO: will update the inference codes on 02/12/2023. We found a bug in the original codes so the testing performances are slightly better than the paper.)
